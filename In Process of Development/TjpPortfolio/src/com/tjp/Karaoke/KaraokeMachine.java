...
import com.tjp.Karaoke.models.Song;
...
public class KaraokeMachine {
    ...
    public KaraokeMachine(SongBook songBook) {
        ...
        mMenu.put("Play", "Play the next song queued!");
    ...
    public void playNext() {
        ...
        if (songRequest == null) {
            System.out.println("Sorry, there are no songs in the queue." +
                    "Add songs to the queue by using the choose option in the menu.");
        } else {
            Song song = songRequest.getSong();
            System.out.printf("%n%n%n Ready %s? Open %s to play %s by %s %n%n%n",
